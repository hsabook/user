...
import { mockVACT } from '@/lib/mockResponseDataCategories';
  ...
  return (
    <Link href={`/books/${book.id}`} className="block w-[220px] flex-shrink-0 bg-white rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-all border-[1px] border-green-400">
      <div className="flex flex-col h-full">
        <div className="w-full h-[220px] relative overflow-hidden bg-[#ee4a62]">
          <Image 
...
export default function VACTBookSection() {
  ...
  return (
    <div className="mb-8">
      <div className="flex items-center justify-between mb-4">
        <h2 className="text-xl font-medium">Sách đánh giá năng lực VACT</h2>
        <Link href="/books/vact" className="text-[#1ab69d] hover:underline text-sm flex items-center">
          Xem tất cả
