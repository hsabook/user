      ...
      <div className="relative w-96" ref={searchRef}>
        <form onSubmit={handleSearch}>
          <div className="relative">
            ...
            <input
              type="text"
              className="pl-10 pr-10 py-2 w-full border border-green-100 bg-white/50 backdrop-blur-sm rounded-xl focus:outline-none focus:ring-1 focus:ring-green-400 focus:border-green-400 transition-all shadow-sm"
        ...
        {showResults && (
          <div className="fixed inset-0 bg-black/5 z-10" onClick={() => setShowResults(false)}>
            <div 
              className="absolute top-0 left-0 right-0 mt-16 mx-auto max-w-xl bg-white/95 backdrop-blur-md rounded-2xl shadow-xl border border-green-50 overflow-hidden z-50"
        ...
        <input
          type="text"
                    className="pl-10 pr-10 py-2.5 w-full border border-green-100 bg-white/70 backdrop-blur-sm rounded-xl focus:outline-none focus:ring-1 focus:ring-green-400 focus:border-green-400 transition-all"
                    placeholder="Tìm kiếm mã sách, ID đề, chương..."
                    value={searchTerm}
                    onChange={handleSearchInputChange}
                    autoFocus
