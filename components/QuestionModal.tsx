...
const QuestionModal = ({ question, onClose, isOpen }: QuestionModalProps) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-40 backdrop-blur-sm flex items-center justify-center z-50 p-4 transition-all duration-300">
      <div className="w-full max-w-3xl max-h-[90vh] bg-white bg-opacity-90 backdrop-filter backdrop-blur-md rounded-xl border border-green-200 shadow-xl relative flex flex-col">
        {/* Header Modal */}
