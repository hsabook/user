...
const QuestionModal = ({ question, onClose, isOpen }: QuestionModalProps) => {
  ...
  return (
    <div
      className="fixed inset-0 top-0 left-0 right-0 bottom-0 m-0 p-0 w-full h-full min-h-screen bg-black/50 backdrop-blur-sm z-[9999]"
      style={{ margin: 0 }}
    >
      <div
        className="fixed inset-0 top-0 left-0 right-0 bottom-0 m-0 w-full h-full flex items-center justify-center p-4"
        style={{ margin: 0 }}
      >
        <div
          ref={modalRef}
        ...
        >
          ...
          <div className="flex justify-between items-center border-b border-green-100 px-6 py-4 bg-gradient-to-r from-green-50 to-green-100 rounded-t-xl sticky top-0 z-10">
            <h3 className="text-lg font-medium text-green-800">
              Câu hỏi:{" "}
              <span className="text-green-600">{question.code_id}</span>
            </h3>
